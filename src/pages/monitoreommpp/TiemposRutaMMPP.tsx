        ...
        <div className="p-8 min-h-screen bg-gray-50/50">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8 mt-2">
                <div className="space-y-1">
                    <h1 className="text-2xl font-bold tracking-tight text-gray-900">Configuración de Tiempos de Ruta</h1>
                    <p className="mt-1 text-sm text-gray-500 tracking-wide">Mantenimiento de Trayectorias y Tiempos Estimados</p>
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                    <div className="relative group">
                        ...
                        <input
                            ...
                            className="pl-10 pr-4 py-2.5 bg-white border border-slate-200 rounded-xl text-sm focus:ring-4 focus:ring-red-500/10 focus:border-red-500 outline-none w-full sm:w-80 transition-all font-semibold"
                            value={searchTerm}
                    ...
                    <button
                        ...
                        className="flex items-center justify-center gap-2 px-4 py-2.5 bg-[#ff0000] text-white rounded-xl hover:bg-red-700 transition-all font-bold text-sm border border-red-600 active:scale-95"
                    >
                    ...
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className="bg-gray-50 border-b border-slate-200">
                                ...
                                <th className="px-6 py-4 text-xs font-semibold text-gray-500 uppercase tracking-wider">Trayectoria</th>
                                <th className="px-6 py-4 text-xs font-semibold text-gray-500 uppercase tracking-wider">Tipo</th>
                                <th className="px-6 py-4 text-xs font-semibold text-gray-500 uppercase tracking-wider text-center">Tiempos (Min/Max)</th>
                            ...
                            {filteredRoutes.length > 0 ? (
                                filteredRoutes.map((route) => (
                                    <tr key={route.id} className="hover:bg-slate-50/50 transition-colors group">
                                        ...
                                        <td className="px-6 py-4">
                                            <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-[10px] font-semibold tracking-wider border bg-slate-100 text-slate-600 border-slate-200 uppercase">
                                                {route.tipo_ruta}
                                            </span>
                                        </td>
                        ...
                        <form onSubmit={handleSave} className="p-6 space-y-4">
                            <div className="grid grid-cols-1 gap-4">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div className="grid grid-cols-2 gap-2">
                                        <div>
                                            <label className="block text-[10px] font-semibold text-slate-400 uppercase mb-1.5 tracking-wide">T. Min (m)</label>
                                            <input
                                                type="number"
                                                required
                                                className="w-full px-3 py-2 bg-white border border-slate-200 rounded-lg focus:ring-2 focus:ring-red-500/10 focus:border-red-500 outline-none font-semibold text-sm"
                                        ...
                                        <div>
                                            <label className="block text-[10px] font-semibold text-slate-400 uppercase mb-1.5 tracking-wide">T. Max (m)</label>
                                            <input
                                                type="number"
                                                required
                                                className="w-full px-3 py-2 bg-white border border-slate-200 rounded-lg focus:ring-2 focus:ring-red-500/10 focus:border-red-500 outline-none font-semibold text-sm"
                            ...
                            <div className="flex justify-end gap-3 mt-8 pt-4 border-t border-slate-100">
                                <button
                                    ...
                                    className="px-4 py-2 text-sm font-semibold text-slate-500 hover:bg-slate-50 rounded-xl transition-colors uppercase tracking-wide"
                                >
                                    Cancelar
                                </button>
                                <button
                                    type="submit"
                                    disabled={isSaving}
                                    className="flex items-center gap-2 px-6 py-2 bg-[#ff0000] text-white rounded-xl hover:bg-red-700 transition-all font-bold text-sm border border-red-600 disabled:opacity-50"
                                >
